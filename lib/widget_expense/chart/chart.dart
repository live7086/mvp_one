...
import 'package:mvp_one/widget_expense/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ExpenseBucket.forCategory(expenses, Category.Upperbody),
      ExpenseBucket.forCategory(expenses, Category.Lowerbody),
      ExpenseBucket.forCategory(expenses, Category.Fullbody),
