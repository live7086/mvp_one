...
// r_elbow angle
  const int r_elbow_perfect_min = 40;
  const int r_elbow_good_min = r_elbow_perfect_min - 10;
  const int r_elbow_perfect_max = 60;
  const int r_elbow_good_max = r_elbow_perfect_max + 10;
